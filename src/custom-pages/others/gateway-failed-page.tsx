...
import GatewayFailedImg from "../../../public/images/gateway-failed-img.png";

const GatewayFailedPage = () => {
  ...
  return (
    <main className="h-[calc(100svh-170px)] flex-center layout-standard flex-col gap-16">
      ...
      <Image src={GatewayFailedImg} alt="Gateway Failed" width={300} />
...
export default GatewayFailedPage;
