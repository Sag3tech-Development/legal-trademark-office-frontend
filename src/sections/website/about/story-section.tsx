    ...
    <section className="layout-standard section-margin-standard section-padding-standard grid lg:grid-cols-2 col-span-1 lg:gap-12">
      <div className="col-span-1 flex flex-col h-full justify-center gap-8">
        ...
        <div className="flex flex-col gap-4 lg:text-lg md:text-base text-sm">
          ...
          <p>
            In 2010, after a decade of growing our services, we innovated again,
            and created an independent network of attorneys so our customers
            could get personalized legal advice—without having to leave home.
          </p>

          <p>
            With offices in Los Angeles, Austin, and the Bay Area, our united
            workforce of talented, diverse, and inclusive Zoomers is our recipe
            for success, and the reason we&apos;re able to empower millions to
            make their dreams official.
          </p>
        </div>
      </div>
