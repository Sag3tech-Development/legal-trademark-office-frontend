...
import { CustomSelectionProps } from "@/interfaces/common-component-interfaces";
          ...
          <FormControl>
            <div className="w-full grid md:grid-cols-4 grid-cols-2 gap-4">
              {options.map((option) => (
                ...
                >
                  <div
                    className={`h-[180px] w-full rounded-[10px] bg-secondary-background flex-center p-4 cursor-pointer ${
                  ...
                  <h1
                    className={`md:text-base text-sm text-heading font-normal ${
